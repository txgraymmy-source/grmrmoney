    ...
    <div className="relative">
      ...
      {showMenu && (
        <>
          ...
          />
          <div className="absolute right-0 mt-2 w-56 bg-[rgba(37,37,37,0.5)] border border-[rgba(120,120,128,0.2)] rounded-xl shadow-xl z-20 overflow-hidden">
            <button
              onClick={() => {
                setShowMenu(false)
                handleArchive()
              ...
              disabled={loading}
              className="w-full px-4 py-3 text-left text-sm text-yellow-400 hover:bg-[rgba(118,118,128,0.12)] transition-colors disabled:opacity-50 flex items-center gap-3"
            >
            ...
            <button
              ...
              disabled={loading}
              className="w-full px-4 py-3 text-left text-sm text-red-400 hover:bg-[rgba(118,118,128,0.12)] transition-colors disabled:opacity-50 flex items-center gap-3 border-t border-[rgba(120,120,128,0.2)]"
            >
              <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
