      ...
      <CardContent className="space-y-4">
        ...
        <div className="flex gap-2">
          ...
          <Button
            ...
            variant="outline"
            className="bg-[rgba(118,118,128,0.12)] border-[rgba(120,120,128,0.2)] text-white/70 hover:bg-white/[0.08]"
          >
        ...
        {showManual && (
          <form onSubmit={handleManualAdd} className="border-t border-[rgba(120,120,128,0.2)] pt-4 space-y-4">
            <div className="grid grid-cols-2 gap-4">
              <div className="space-y-2">
                <Label htmlFor="amount" className="text-white/70">Сумма ($)</Label>
                <Input
                  id="amount"
                  type="number"
                  step="0.01"
              ...
              <div className="space-y-2">
                <Label htmlFor="type" className="text-white/70">Тип</Label>
                <select
                  id="type"
                  ...
                  className="flex h-10 w-full rounded-md border border-[rgba(120,120,128,0.2)] bg-[rgba(118,118,128,0.12)] px-3 py-2 text-sm text-white"
                >
            ...
            <div className="space-y-2">
              <Label htmlFor="description" className="text-white/70">Описание</Label>
              <Input
                id="description"
                type="text"
